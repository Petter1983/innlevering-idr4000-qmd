...
mhc <- read_excel("filer/mhc1.xlsx")
cv <- read_excel("filer/mhc1.xlsx")
...
ct = read_excel("filer/mhc1.xlsx")%>%
  ...
  gt(ct) %>%
    tab_header(title = "CT-verdier",
    subtitle = "Tallene er antall sykluser før syklisk terskel er nådd")%>%
